...
class NotesListAdapter(private val mContext: Context): RecyclerView.Adapter<NotesListAdapter.MyViewHolder>() {
    private val notesList: ArrayList<NotesModel> = arrayListOf()
    ...
    fun setNotesList(list: ArrayList<NotesModel>){
        notesList.clear()
